...
public class ParameterCollection : Dictionary<string, object>
{
    ...
    {
        Add(key, value.ConvertToMilliseconds().ToString(CultureInfo.InvariantCulture));
    }
    ...
    {
        Add(key, value.ConvertToSeconds().ToString());
    }
    ...
    {
        var stringVal = MapConverter.GetString(value);
    ...
    public void SetBody(object body)
    {
        ...
        Add(RestApiConstants.RequestBodyParameterKey, body);
    }
}
